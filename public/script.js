  ...
  addQuestionBtn.addEventListener("click", function () {
    ...
    const questionHTML = `
            <div class="question">
                ...
                <input type="text" id="option_${questionCounter}_1" name="questions[${questionCounter}][options][0]">
                <br>
                <label for="option_${questionCounter}_2">Option 2</label>
                <input type="text" id="option_${questionCounter}_2" name="questions[${questionCounter}][options][1]">
                <br>
                <label for="option_${questionCounter}_3">Option 3</label>
                <input type="text" id="option_${questionCounter}_3" name="questions[${questionCounter}][options][2]">
                <br>
                <label for="option_${questionCounter}_4">Option 4</label>
                <input type="text" id="option_${questionCounter}_4" name="questions[${questionCounter}][options][3]">
                <br>
            </div>
        `;
